 ...
 #
 #   build-SensorEmulationRemoteServer.sh is distributed in the hope that it will be useful,
...
set -x
gcc -Wall -O2 AccelerometerRemoteServer.c -o AccelerometerRemoteServer
